...
class ChatbotView(APIView):
    ...
    def post(self, request):
        ...
        SYSTEM_PROMPT = (
            "Eres un ayudande en un tienda de dulces virtual. "
            "Usa solo la información provista en el 'CONTEXT' para responder "
            "consultas sobre productos, disponibilidad del stock y promociones. "
            "Si no puedes responder con la información disponible, indica que no puedes responder.",
            "Si te preguntan sobre la informacion de la que dispones, dile que hay en el stock y menciona las promociones"
        )
